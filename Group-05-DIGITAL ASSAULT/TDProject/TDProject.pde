...
void setup(){
  ...
  bgm[0] = new FilePlayer(minim.loadFileStream("bgm/robots.mp3",512,true));
  bgm[1] = new FilePlayer(minim.loadFileStream("bgm/bx3.mp3",512,true));
  bgm[2] = new FilePlayer(minim.loadFileStream("bgm/hexagon.mp3",512,true));
  bgm[3] = new FilePlayer(minim.loadFileStream("bgm/sudden.mp3",512,true));
  bgm[4] = new FilePlayer(minim.loadFileStream("bgm/technologic.mp3",512,true));
  bgm[5] = new FilePlayer(minim.loadFileStream("bgm/maths.mp3",512,true));
  bgm[6] = new FilePlayer(minim.loadFileStream("bgm/exposed.mp3",512,true));
  bgm[7] = new FilePlayer(minim.loadFileStream("bgm/exit.mp3",512,true));
  bgm[8] = new FilePlayer(minim.loadFileStream("bgm/blood.mp3",512,true));
